...
**Art style guide & prompting reference**: See [`lore/art-prompting-guide.md`](lore/art-prompting-guide.md) for comprehensive style analysis, prompting principles, and the prompt template. All creature prompts follow that guide.

Each creature gets a specific prompt built on the standard template. One hero image per creature.

#### Creature Image Prompts

All creature prompts are maintained in **[`lore/art-prompting-guide.md`](lore/art-prompting-guide.md) § 4** — that file is the single authoritative source. Edit prompts there only.
